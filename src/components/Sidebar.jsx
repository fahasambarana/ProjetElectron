    ...
    >
      ...
      <div className="flex items-center justify-between p-5 border-b border-gray-700">
        ...
        <button
          ...
          className="p-2 rounded-lg bg-gray-800 text-gray-300 hover:bg-gray-700 hover:text-white transition-all shadow-md"
        >
      ...
      <div className="px-3 py-4 border-t border-gray-700 space-y-2">
        ...
        <button
          ...
          className="
            ...
            text-gray-300 hover:bg-gray-750 hover:text-white transition-all
            relative group
          "
        >
          {darkMode ? <Sun size={22} /> : <Moon size={22} />}
          {!collapsed && (
            <span className="ml-4 font-medium transition-all">
        ...
        >
          <HelpCircle size={22} />
          {!collapsed && (
            <span className="ml-4 font-medium transition-all">Aide & Support</span>
          )}
          {collapsed && (
            <div
              className="absolute left-full top-1/2 transform -translate-y-1/2 ml-3
