...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-black to-blue-500 p-4">
      <div className="w-full max-w-md">
        <div className="bg-teal-100 rounded shadow-xl overflow-hidden">
          <div className="px-8 py-6">
            ...
            {error && (
              <div className="mb-6 p-3 bg-red-50 text-red-700  flex items-center">
